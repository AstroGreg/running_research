...
const runCommands = {
    win32: {
        ...
        link: () => shell.exec('mklink /D "%SPLUNK_HOME%\\etc\\apps\\davinsi" "%cd%\\demo\\splunk-app"'),
    },
    nix: {
        ...
        link: () => shell.exec('ln -s $PWD/demo/splunk-app $SPLUNK_HOME/etc/apps/davinsi-demo-app'),
    },
};
